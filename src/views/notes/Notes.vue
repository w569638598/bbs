    ...
    <v-row class="text-center">
      <v-col sm="12" md="9" >
        ...
        >
          <v-card-title class="pa-3" style="border-bottom: 1px solid #e8e8e8;">
            <v-icon class="mr-2">fa fa-book</v-icon>咨询札记
          </v-card-title>
      ...
      <v-col sm="12" md="3" class="hidden-sm-and-down">
        <v-card class="ma-0" :elevation="2">
          <v-card-title style="border-bottom: 1px solid #e8e8e8;">💐 发表</v-card-title>
          <v-card-actions v-if="token != null && token !== ''" style="padding:24px;" class="flex justify-center">
            <v-btn :to="{path:'/post/create/notes',query:{title:'咨询札记'}}" color="#167df0" outlined>✍ 发表 </v-btn>
          </v-card-actions>
